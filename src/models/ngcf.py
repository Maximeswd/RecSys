...
class NGCF(object):
    ...
    def _split_A_hat_node_dropout(self, X):
        ...
        for i_fold in range(self.n_fold):
            ...
            A_fold_hat.append(
                self._dropout_sparse(temp, 1 - self.node_dropout[0], n_nonzero_temp)
            )
...
"""
    ...
    *********************************************************
    ...
    if args.pretrain == -1:
        pretrain_data = load_pretrained_data(args=args)
    else:
        pretrain_data = None
    ...
    *********************************************************
    ...
    if args.report == 1:
        ...
        report_path = "%sreport/%s/%s.result" % (
            args.proj_path,
            args.dataset,
            model.model_type,
        )
