...
def test_one_user(x, data_generator, args, Ks):
...
def test(
    ...
    t = partial(test_one_user, data_generator=data_generator, args=args, Ks=Ks)
    result = {
    ...
    for u_batch_id in range(n_user_batchs):
        ...
        batch_result = pool.map(t, user_batch_rating_uid)
